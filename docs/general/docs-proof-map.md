...
| Public package READMEs describe the latest package surface only. | `packages/slate/Readme.md`, `packages/slate-react/Readme.md`, `packages/slate-dom/README.md`, `packages/slate-browser/README.md`, `packages/slate-history/Readme.md`, `packages/slate-hyperscript/Readme.md`, `packages/slate-layout/README.md`, `packages/slate-yjs/README.md` | `packages/slate/test/public-surface-contract.ts`, `packages/slate-react/test/surface-contract.tsx`, `packages/slate-layout/test/page-layout-contract.test.ts`, `packages/slate-yjs/test/package-config-contract.spec.ts` |
...
| Slate Browser is public test infrastructure, not the editor runtime API. | `libraries/slate-browser.md`, `packages/slate-browser/README.md`, `releases/slate-v2.md` | `packages/slate-browser/test/core/package-scripts.test.ts`, `packages/slate/test/public-package-import-smoke.test.ts`, `packages/slate/test/public-package-types-smoke.ts`, `packages/slate/test/public-surface-contract.ts` |
...
| `@slate/yjs` owns the Yjs adapter while provider packages, auth, persistence, room naming, and server scaling stay in application code. | `libraries/slate-yjs.md`, `walkthroughs/07-operation-replay-substrate.md`, `releases/slate-v2.md`, `packages/slate-yjs/README.md` | `packages/slate-yjs/test/package-config-contract.spec.ts`, `packages/slate-yjs/test/provider-contract.spec.ts`, `packages/slate-yjs/test/react-contract.spec.tsx`, `scripts/proof/yjs-hocuspocus-production-soak.mjs` |
...
| Visual/native selection screenshots | `richtext`, `plaintext`, `custom-placeholder`, `dom-coverage-boundaries`, `images`, `inlines`, `tables` | `playwright/integration/examples/visual-native-selection-smoke.test.ts`, `packages/slate-browser/src/playwright/index.ts` |
...
| Yjs collaboration and Hocuspocus provider proof | `yjs-collaboration`, `yjs-hocuspocus` | `packages/slate-yjs/test`, `scripts/proof/yjs-hocuspocus-production-soak.mjs` |
