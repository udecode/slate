...
| Public package READMEs describe the latest package surface only. | `packages/slate/Readme.md`, `packages/slate-react/Readme.md`, `packages/slate-dom/README.md`, `packages/slate-browser/README.md`, `packages/slate-history/Readme.md`, `packages/slate-hyperscript/Readme.md`, `packages/slate-layout/README.md` | `packages/slate/test/public-surface-contract.ts`, `packages/slate-react/test/surface-contract.tsx`, `packages/slate-layout/test/page-layout-contract.test.ts` |
