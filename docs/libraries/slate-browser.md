...
- `slate-browser/playwright` for Playwright editor harnesses.
- `slate-browser/core` for pure proof contracts, release-proof artifacts,
  classifiers, and selection serialization helpers.
- `slate-browser/browser` for DOM selection snapshots and zero-width
  placeholder inspection in browser-capable test environments.
- `slate-browser/transports` for device/browser proof-scope descriptors.
