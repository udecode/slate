...
```ts
import { NodeApi, type Descendant } from 'slate'
...
import { ElementApi, TextApi, type Descendant } from 'slate'
...
`slate-hyperscript` is useful for tests and fixtures. Production
