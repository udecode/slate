...
const libraryDocsPath = fileURLToPath(
  new URL('../../../docs/libraries/slate-hyperscript.md', import.meta.url)
)
...
describe('slate-hyperscript package README contract', () => {
  ...
  it('names the root fixture factory exports in package and library docs', () => {
    const docs = [
      readFileSync(packageReadmePath, 'utf8'),
      readFileSync(libraryDocsPath, 'utf8'),
    ].join('\n')
