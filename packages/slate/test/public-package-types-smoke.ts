type PublicPackageModules = [
  ...
  typeof import('@slate/yjs'),
  typeof import('@slate/yjs/core'),
  typeof import('@slate/yjs/react'),
...
type PublicPackageNamedExports = [
  ...
  typeof import('@slate/yjs').createYjsExtension,
  typeof import('@slate/yjs/core').createYjsAwarenessSelection,
  typeof import('@slate/yjs/react').useYjsRemoteCursors,
...
type PublicPackageNamedTypeExports = [
  ...
  import('slate').Text,
  import('slate').Value,
  import('@slate/yjs').YjsExtensionOptions,
  import('@slate/yjs').YjsProviderLike,
  import('@slate/yjs').YjsState,
  import('@slate/yjs').YjsTx,
  import('@slate/yjs/react').YjsRemoteCursorDecorationData,
  import('@slate/yjs/react').YjsRemoteCursorOverlayPosition,
