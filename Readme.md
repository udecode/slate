...
> 🤖 **Slate is in active development.** Its core API is usable for current editor work, and advanced use cases may still need focused improvements or bug fixes. The project optimizes for the right long-term editor architecture over premature API freeze.
